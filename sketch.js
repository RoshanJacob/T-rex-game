...
var coinArray =[];
var stoneArray = [];
var plrImg,groundImg,fireImg,cactusImg,cactusImg2,cloudImg,cloudImg2,backgroundImg,coinImg,lifeImg,collidedPlayerImg,resetButton;
var gameOverImg,explosionImg,noFire,stoneImg;
...
var heart3;
function preload(){
plrImg = loadAnimation('images/frame0.gif','images/frame1.gif','images/frame2.gif','images/frame3.gif','images/frame4.gif','images/frame5.gif','images/frame6.gif','images/frame7.gif','images/frame8.gif','images/frame9.gif');
groundImg = loadImage('images/ground.png');

fireImg = loadAnimation('images/flame0.gif','images/flame1.gif','images/flame2.gif','images/flame3.gif','images/flame4.gif','images/flame5.gif','images/flame6.gif','images/flame7.gif','images/flame8.gif','images/flame9.gif');
...
invisibleGround = createSprite(displayWidth/2,displayHeight - 185,2000,10);
...
heart2 = createSprite(displayWidth/2-500,displayHeight/2-250,50,50);
heart2.addImage("heart",lifeImg);
heart2.scale = 0.2;

heart3 = createSprite(displayWidth/2-400,displayHeight/2-250,50,50);
...
// image(groundImg,displayWidth/2,displayHeight-99);

//playState
if(gameState === 1){
ground.loop();
// invisibleGround.loop();

ground.ground.velocityX = -(10 + count/100);
// invisibleGround.ground.velocityX = -(10 + count/100);
...
function keyPressed(){
if(keyCode === 32 && gameState === 1 && player.player.y > displayHeight/1.5){
player.jump();
jumpSound.play();
console.log("working");
}
